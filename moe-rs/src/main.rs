//! moe-rs — a from-scratch CPU inference engine for the 500M bailingmoe2 MoE LLM.
...
#[derive(Parser)]
#[command(about = "CPU inference for the 500M bailingmoe2 MoE (F32 GGUF)")]
struct Args {
    /// Path to the F32 bailingmoe2 GGUF
    #[arg(short, long)]
    model: PathBuf,
    /// Prompt text
